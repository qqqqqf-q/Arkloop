...
func RegisterRoutes(mux *nethttp.ServeMux, deps Deps) {
	...
	mux.HandleFunc("/v1/market/skills/import", marketSkillsImportEntry(deps.AuthService, deps.OrgMembershipRepo, deps.APIKeysRepo, deps.AuditWriter, deps.PlatformSettingsRepo, deps.SkillPackagesRepo, deps.SkillStore))
	mux.HandleFunc("/v1/skill-packages/import/registry", marketSkillsImportEntry(deps.AuthService, deps.OrgMembershipRepo, deps.APIKeysRepo, deps.AuditWriter, deps.PlatformSettingsRepo, deps.SkillPackagesRepo, deps.SkillStore))
	mux.HandleFunc("/v1/skill-packages/import/skillsmp", marketSkillsImportEntry(deps.AuthService, deps.OrgMembershipRepo, deps.APIKeysRepo, deps.AuditWriter, deps.PlatformSettingsRepo, deps.SkillPackagesRepo, deps.SkillStore))
