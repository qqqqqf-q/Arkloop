...
func (e *executor) doList(
	ctx context.Context,
	repo data.ScheduledJobsRepository,
	accountID uuid.UUID,
	started time.Time,
) tools.ExecutionResult {
	jobs, err := repo.ListByAccount(ctx, e.pool, accountID)
	if err != nil {
...
func (e *executor) doGet(
	...
	job, err := repo.GetByID(ctx, e.pool, jobID, accountID)
	if err != nil {
...
func (e *executor) doCreate(
	...
	created, err := repo.CreateJob(ctx, e.pool, job)
	if err != nil {
...
func (e *executor) doUpdate(
	...
	if err := repo.UpdateJob(ctx, e.pool, jobID, accountID, upd); err != nil {
...
func (e *executor) doDelete(
	...
	if err := repo.DeleteJob(ctx, e.pool, jobID, accountID); err != nil {
