...
var ExecCommandAgentSpec = tools.AgentToolSpec{
	Name:        "exec_command",
	Version:     "1",
	Description: "run a command in the isolated VM, either buffered or as an explicit interactive process",
...
var ContinueProcessAgentSpec = tools.AgentToolSpec{
	...
	Version:     "1",
	Description: "continue a running VM process by reading output and optionally sending stdin",
	RiskLevel:   tools.RiskLevelHigh,
	SideEffects: true,
}
...
var TerminateProcessAgentSpec = tools.AgentToolSpec{
	...
	Version:     "1",
	Description: "terminate a running VM process",
	RiskLevel:   tools.RiskLevelHigh,
	SideEffects: true,
}
...
var ResizeProcessAgentSpec = tools.AgentToolSpec{
	Name:        "resize_process",
	Version:     "1",
	Description: "resize a running PTY VM process",
	RiskLevel:   tools.RiskLevelHigh,
	SideEffects: true,
}
