...
func (SkillsRepository) ResolveEnabledSkills(ctx context.Context, pool DesktopDB, accountID uuid.UUID, profileRef, workspaceRef string) ([]skillstore.ResolvedSkill, error) {
	if ctx == nil {
