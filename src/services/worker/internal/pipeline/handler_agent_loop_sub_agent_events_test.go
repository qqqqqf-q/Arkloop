...
func TestEventWriterAppend_AppendsSubAgentCompletedEvent(t *testing.T) {
	...
	writer := newEventWriter(pool, data.Run{ID: runID, AccountID: accountID, ThreadID: threadID}, "trace-1", nil, nil, nil, "", "", data.UsageRecordsRepository{}, data.CreditsRepository{}, 1000, 1, nil, nil, nil, nil, creditpolicy.DefaultPolicy, nil, nil, nil)
...
func TestEventWriterAppend_AppendsSubAgentCancelledEventOnCancelRequest(t *testing.T) {
	...
	writer := newEventWriter(pool, data.Run{ID: runID, AccountID: accountID, ThreadID: threadID}, "trace-2", nil, nil, nil, "", "", data.UsageRecordsRepository{}, data.CreditsRepository{}, 1000, 1, nil, nil, nil, nil, creditpolicy.DefaultPolicy, nil, nil, nil)
...
func TestEventWriterAppend_AutoQueuesNextRunFromPendingInputs(t *testing.T) {
	...
	writer := newEventWriter(pool, data.Run{ID: childRunID, AccountID: accountID, ThreadID: childThreadID, ParentRunID: &parentRunID}, "trace-3", nil, nil, jobQueue, "", "", data.UsageRecordsRepository{}, data.CreditsRepository{}, 1000, 1, nil, nil, nil, nil, creditpolicy.DefaultPolicy, nil, nil, nil)
...
func TestEventWriterAppend_TouchesRunActivityOnNonTerminalCommit(t *testing.T) {
	...
	writer := newEventWriter(pool, data.Run{ID: runID, AccountID: accountID, ThreadID: threadID}, "trace-activity", nil, nil, nil, "", "", data.UsageRecordsRepository{}, data.CreditsRepository{}, 1000, 1, nil, nil, nil, nil, creditpolicy.DefaultPolicy, nil, nil, nil)
