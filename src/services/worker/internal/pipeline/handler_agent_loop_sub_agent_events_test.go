...
func TestEventWriterAppend_AppendsSubAgentCompletedEvent(t *testing.T) {
	...
	writer := newEventWriter(pool, data.Run{ID: runID, AccountID: accountID, ThreadID: threadID}, "trace-1", nil, nil, nil, "", "", 1, nil, nil, nil, nil, false, nil, nil, nil, "", nil, nil, false)
...
func TestEventWriterAppend_AppendsSubAgentCancelledEventOnCancelRequest(t *testing.T) {
	...
	writer := newEventWriter(pool, data.Run{ID: runID, AccountID: accountID, ThreadID: threadID}, "trace-2", nil, nil, nil, "", "", 1, nil, nil, nil, nil, false, nil, nil, nil, "", nil, nil, false)
...
func TestEventWriterNotifiesVisibleTextDelta(t *testing.T) {
	...
	rc := &RunContext{}
	writer := newEventWriter(pool, data.Run{ID: runID, AccountID: accountID, ThreadID: threadID}, "trace-visible-delta", nil, nil, nil, "", "", 1, nil, nil, nil, nil, false, nil, nil, nil, "", nil, nil, false)
...
func TestEventWriterAppend_AutoQueuesNextRunFromPendingInputs(t *testing.T) {
	...
	writer := newEventWriter(pool, data.Run{ID: childRunID, AccountID: accountID, ThreadID: childThreadID, ParentRunID: &parentRunID}, "trace-3", nil, nil, jobQueue, "", "", 1, nil, nil, nil, nil, false, nil, nil, nil, "", nil, nil, false)
...
func TestEventWriterAppend_TouchesRunActivityOnNonTerminalCommit(t *testing.T) {
	...
	writer := newEventWriter(pool, data.Run{ID: runID, AccountID: accountID, ThreadID: threadID}, "trace-activity", nil, nil, nil, "", "", 1, nil, nil, nil, nil, false, nil, nil, nil, "", nil, nil, false)
...
func TestEventWriterAppend_ConsumesPendingCallbacksOnCompletedRun(t *testing.T) {
	...
	writer := newEventWriter(pool, data.Run{ID: runID, AccountID: accountID, ThreadID: threadID}, "trace-consume", nil, nil, nil, "", "", 1, nil, nil, nil, nil, false, nil, nil, nil, "", nil, []uuid.UUID{callbackID}, false)
...
func TestEventWriterAppend_KeepsPendingCallbacksOnFailedRun(t *testing.T) {
	...
	writer := newEventWriter(pool, data.Run{ID: runID, AccountID: accountID, ThreadID: threadID}, "trace-failed", nil, nil, nil, "", "", 1, nil, nil, nil, nil, false, nil, nil, nil, "", nil, []uuid.UUID{callbackID}, false)
...
func TestAgentLoopHandlerShortCircuitsStaleCallbackRun(t *testing.T) {
	...
	handler := NewAgentLoopHandler(data.RunsRepository{}, data.RunEventsRepository{}, data.MessagesRepository{}, nil, &stubJobQueue{})
	rc := &RunContext{
		Run:       data.Run{ID: runID, AccountID: accountID, ThreadID: threadID},
		Pool:      pool,
...
func TestEventWriterFlushRewakesPendingCallbackAfterCallbackRunCompletes(t *testing.T) {
	...
	jobQueue := &stubJobQueue{}
	writer := newEventWriter(pool, data.Run{ID: runID, AccountID: accountID, ThreadID: threadID}, "trace-rewake", nil, nil, jobQueue, "", "", 1, nil, nil, nil, nil, false, nil, nil, nil, runkind.SubagentCallback, uuidPtr(callbackID), nil, false)
