...
| 环境 | 地址 |
|------|------|
| 本地开发（直连） | `http://127.0.0.1:8001` |
| 本地开发（经 Gateway） | `http://127.0.0.1:8000` |
...
### 配置
- [LLM Credentials](./llm-credentials) — LLM 提供商凭证与路由
- [MCP Configs](./mcp-configs) — MCP 服务器配置
- [Agent Configs](./agent-configs) — Agent 配置与 Prompt 模板
