...
图表风格要求：使用浅蓝色系（如 #45B7D1、#4ECDC4）作为主色调，文字颜色 #737373。折线图必须使用 fill="tozeroy" 填充线下区域（半透明色）。图例水平放置于图表上方（orientation='h'）。标题下方附带浅灰小字副标题说明数据来源或关键结论。整体风格简洁现代，无边框、透明背景。
<charts>
<tool `memory_search`>
...
<mindmap>
如果需要思维导图，请使用以下格式输出，但在日常交流中，应少用思维导图进行输出，请注意这一点
```mindmap
   # 主题
   ## 分支 A
   ### 细节 1
