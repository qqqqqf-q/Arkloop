...
export const en: LocaleStrings = {
  ...
  desktopSettings: {
    ...
    // OpenViking config
    memoryToolModel: "Memory Tool Model",
    memoryToolModelDesc: "Choose from your configured models for memory extraction and summarization.",
    ...
    memoryConfigureMissingModels: "Choose both a memory tool model and an embedding model first.",
