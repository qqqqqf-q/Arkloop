...
export const en: LocaleStrings = {
  ...
  skills: {
    ...
    marketUnconfiguredBody:
      "You can still upload a skill or import one from GitHub.",
    ...
    emptyBodyNoMarket:
      "Upload a skill or import one from GitHub to get started.",
    ...
    officialDialogSubtitle:
      "Switch to the ClawHub list and install from there.",
    officialDialogHintTitle: "ClawHub skills install directly",
    officialDialogHintBody:
      "Once opened, you can search the ClawHub list and install a skill.",
    ...
    trySkillPrompt: (skillKey: string) =>
      `I just added the /${skillKey} skill to Arkloop. Can you demonstrate it with some great examples?`,
