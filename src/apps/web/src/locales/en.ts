...
export const en: LocaleStrings = {
  ...
  channels: {
    ...
    allowedUsersPlaceholder: 'Enter Telegram user IDs separated by commas or new lines',
    persona: 'Persona',
    ...
    allowlistRequired: 'Add at least one Telegram user ID before activating the channel',
    telegram: 'Telegram',
    discord: 'Discord',
    feishu: 'Feishu',
