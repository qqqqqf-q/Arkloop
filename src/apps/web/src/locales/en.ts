...
export const en: LocaleStrings = {
  ...
  desktopSettings: {
    ...
    memoryToolModelDesc: "LLM used by OpenViking to extract and summarize memories.",
    memoryEmbeddingModel: "Embedding Model",
    memoryEmbeddingModelDesc: "Model used for semantic search. Mark models with the 'emb' tag in Provider Settings.",
    ...
    memoryNoEmbeddingModels: "No embedding models found. Mark models with the 'emb' tag in Provider Settings.",
