              ...
              >
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                  <button
                    ...
                    style={{ color: '#333333', background: '#FFFFFF', borderRadius: '8px' }}
                    onMouseEnter={(e) => (e.currentTarget.style.background = '#F3F3F3')}
                    onMouseLeave={(e) => (e.currentTarget.style.background = '#FFFFFF')}
                  >
                    <Paperclip size={14} style={{ color: '#333333', flexShrink: 0 }} />
                    从本地文件添加
                  </button>
                  <button
                    type="button"
                    ...
                    onMouseLeave={(e) => (e.currentTarget.style.background = '#FFFFFF')}
                  >
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" style={{ color: '#333333', flexShrink: 0 }}>
                      ...
                      return (
                        <button
                          ...
                          style={{
                            borderRadius: '8px',
                            background: '#FFFFFF',
                            color: isSelected && isBlue ? '#4691F6' : '#333333',
