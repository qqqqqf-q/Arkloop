  ...
  return (
    <div>
      ...
      >
        ...
        {expanded ? (
          <ChevronDown size={12} style={{ flexShrink: 0, color: 'var(--c-cop-row-subtle-fg)' }} strokeWidth={2} />
        ) : (
          <ChevronRight size={12} style={{ flexShrink: 0, color: 'var(--c-cop-row-subtle-fg)' }} strokeWidth={2} />
        )}
      </button>
