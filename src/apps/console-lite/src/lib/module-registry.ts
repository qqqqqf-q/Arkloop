// Static module registry for degraded mode (Bridge unavailable).
// Derived from install/modules.yaml. When Bridge is online, real data replaces this.
