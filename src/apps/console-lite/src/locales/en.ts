...
export const en: LocaleStrings = {
  ...
  tools: {
    ...
    sectionRerankConfig: 'Rerank Configuration (Optional)',
    fieldRerankProvider: 'Rerank Provider',
    fieldRerankModel: 'Rerank Model',
    fieldRerankApiKey: 'API Key',
    fieldRerankApiBase: 'API Base URL',
    fieldRerankProviderHint: 'Optional. Improves search result quality with reranking',
  ...
  systemSection: {
    ...
    targetVersionPlaceholder: 'e.g. v1.2.0 (latest if empty)',
    upgradeBtn: 'Upgrade',
    upgrading: 'Upgrading…',
