...
export const en: LocaleStrings = {
  ...
  settingsPage: {
    ...
    titleSummarizerNone: 'None',
    email: 'Email',
    emailConfigs: 'SMTP Configs',
    ...
    smtpUser: 'Username',
    smtpPass: 'Password',
    smtpPassPlaceholder: 'Leave blank to keep unchanged',
    smtpTlsMode: 'TLS Mode',
    setDefault: 'Set Default',
    sendTest: 'Send Test',
    testTo: 'Test Recipient',
    noConfigs: 'No SMTP configs yet',
    deleteConfig: 'Delete Config',
    deleteConfigConfirm: (name: string) => `Delete config "${name}"?`,
    system: 'System',
    installSandbox: 'Install Sandbox',
    installBrowser: 'Install Browser',
    copyCommand: 'Copy Command',
    useCredits: 'Use Credits',
    creditsHint: 'When disabled, the platform runs without quota enforcement',
    switchToFullConsole: 'Switch to Full Console',
    toastSaved: 'Saved',
    toastSaveFailed: 'Save failed',
